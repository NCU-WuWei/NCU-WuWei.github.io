...
const PRECACHE_LIST = [
  ...
  "./js/jquery.min.js",
  "./js/bootstrap.min.js",
  "./js/WuWei-blog.min.js",
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-WuWei.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/WuWei-blog.min.css",
...
// Tracking https://twitter.com/NCU-WuWei/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/NCU-WuWei/status/799265578443751424
