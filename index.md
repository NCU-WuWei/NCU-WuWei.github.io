...
# 求职期望
 ...
 - 期望职位：后端技术经理/Java技术经理/Java高级工程师/Agent 应用开发工程师
 - 工作性质：全职
 - 期望薪资：面议
 - 期望城市：广州/惠州/深圳/东莞
...
## 广州联闪惠网络科技有限公司 （ 2025/10 - 至今 ）
- 企业简介：广州联闪惠网络科技有限公司坐落于广州南沙区，是一家专注于AI Agent驱动型智能服务的互联网技术方案提供商。公司以自研多模态大模型与RAG（检索增强生成）技术为核心，构建了面向电商与支付场景的全栈式智能客服助手矩阵——不仅支持多轮对话、上下文理解与情感分析，更具备自主任务规划、工具调用与决策执行能力（如自动退款、订单追踪、风控拦截），实现从“应答式机器人”到“主动式智能体”的跃迁。主营产品覆盖聚合支付系统、AI电商中台及企业级Agent智能客服平台，致力于为商户提供可私有化部署、持续进化的人工智能解决方案。
- 企业规模：30人
- 企业性质：民营企业
- 行业：互联网/AI/电商/金融
- 所在部门: 研发中心
...
## 深圳蓝心汇数字科技有限公司 （ 2023/09 - 2025/10 ）
- 企业简介：深圳蓝心汇数字科技有限公司是深圳赢众科技集团旗下专注于企业级人力资源数字化解决方案的高新技术企业。公司以HRM SaaS服务为核心，主导产品包括云考勤系统、人事管理系统、计薪系统，并深度融合门禁机、AI监控等智能终端设备，致力于通过“软件+硬件”的集成模式，推动企业人力资源管理的数字化与智能化转型。
- 企业规模：500人
- 企业性质：民营企业
- 行业：AI/互联网/物联网
- 所在部门: 研发中心
...
## 佛山市邻家左右家居品牌管理有限公司 （ 2016/07 - 2016/10 ）
...
### 云考勤系统 ```门禁考勤机/智能排班/定位打卡``` （2023/10 - 2025/10）
- 项目描述：项目目是一款基于云计算SAAS架构的智能考勤管理系统，集成人脸识别门禁考勤机、移动APP定位打卡、智能排班管理等核心功能。系统通过采集员工人脸生物识别数据、移动端定位打卡信息，并结合请假、加班等电子审批流程，依据预设班次规则自动归集考勤数据，实现员工月考勤情况的精准核算与自动化管理。该系统特别针对多分支机构、跨区域经营的企业需求设计，支持分布式部署与集中化管理，能够有效解决传统考勤方式存在的数据孤岛、管理效率低下和异地协同困难等痛点。
- 所在公司：深圳蓝心汇数字科技有限公司
- 团队规模：15人
- 项目职务：项目技术经理
- 技术要点
   ...
   - MyBatis 作为持久层框架，使用华为云GaussDB数据库
   - RabbitMQ/Kafka 构建消息队列
   - Redis 使用分布式锁解决高并发问题、热数据缓存、JWT的Token存储
   - K8S Jenkins GitLab 作持续集成、自动化部署项目、容器伸缩扩容
- 项目经历/解决方案/成果
   - 针对上下班高峰期出现的短时10万+考勤打卡并发场景，基于Spring Cloud Alibaba微服务架构，通过Nacos服务注册与发现、Redis分布式锁、RabbitMQ/Kafka消息队列等技术手段，实现了系统的高可用性与弹性扩容能力。
   - 构建了智能考勤分析引擎，能够自动比对打卡时间与排班规则，精准识别迟到、早退、旷工等异常情况，并自动触发预警机制。实现考勤数据自清洗机制，系统可根据预设规则对异常打卡数据进行自动修复与补录，将人工干预需求降低，大幅提升数据准确性与处理效率。
...
- 技术要点
   ...
   - K8S Jenkins GitLab 作持续集成、自动化部署项目、容器伸缩扩容
- 项目经历/解决方案/成果
   - BIM模型构件运算过程中，一栋楼的明细数据多达100万+，为了解决资源瞬间飙升以及处理时间问题，采用分布式管理计算来减轻单节点资源
压力，然后用rabbitMq作为队列中间件来进行处理，调整前，服务在计算大模型容易发生OOM，JVM频频进行Full GC，调整后的效果就是资源反馈稳定，计算时间大幅度缩减(根据服务节点数量而定)。
...
### 邻家左右 ```O2O/线上抢单平台```（2016/07 - 2016/10）
...
# 教育经历
## 南昌大学
- 软件工程/本科 2014.10-2016.11
- 软件技术/专科 2013.9-2016.6
- 专业课程:
